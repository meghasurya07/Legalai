...
export default function HistoryPage() {
    ...
    const { projects, decrementQueryCount } = useVault() // Use global vault context
        ...
        return (
            <div
                ...
                onClick={() => {
                    ...
                    if (conv.projectId) {
                        router.push(`/vault/${conv.projectId}?chatId=${conv.id}`)
                    } else if (conv.workflowId) {
                        router.push(`/workflows/${conv.workflowId}?chatId=${conv.id}`)
                    } else {
                                ...
                                {activeTab === "vault" && projectsWithConversations.length > 0 && (
                                    <Select value={selectedProject} onValueChange={setSelectedProject}>
                                        ...
                                        <SelectContent>
                                            ...
                                            {projectsWithConversations.map(p => (
                            ...
                            {isLoading ? (
                                <div className="flex items-center justify-center py-24">
                                    <div className="flex flex-col items-center gap-3">
                                        ...
                                        <span className="text-sm text-muted-foreground/60">Loading history...</span>
                                    </div>
                                </div>
