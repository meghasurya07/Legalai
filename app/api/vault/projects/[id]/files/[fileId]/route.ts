...
// DELETE /api/vault/projects/[id]/files/[fileId] - Remove file from project
    ...
    try {
        ...
        if (file.url) {
            try {
                ...
                const pathParts = urlObj.pathname.split('/vault/')
        ...
        console.error('Error in DELETE /api/vault/projects/[id]/files/[fileId]:', error)
