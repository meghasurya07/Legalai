...
// GET /api/vault/projects/[id]/files - List files in project
...
// POST /api/vault/projects/[id]/files - Add file to project
export async function POST(request: NextRequest, { params }: RouteParams) {
    try {
        ...
        if (hasText) {
            ingestFile(fileRecord.id, id, extractedText.trim(), file.name)
            ...
            analyzeDocument(fileRecord.id, id, extractedText.trim())
                .then(({ success }) => {
