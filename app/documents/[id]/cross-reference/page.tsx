...
import { CrossReferenceView } from "@/components/documents/cross-reference-view"
...
function CrossReferenceContent() {
    ...
    if (isLoading) {
        return (
            <div className="flex flex-col items-center justify-center h-full gap-4">
                ...
                <p className="text-sm text-muted-foreground">Loading cross-reference tools...</p>
            </div>
        )
    }
    ...
    return (
        <div className="flex flex-col h-full w-full overflow-hidden">
            ...
            {/* Main content */}
            <CrossReferenceView project={project} projectId={projectId} />
        </div>
    )
}
