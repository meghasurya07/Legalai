...
import { VaultHeader } from "@/components/documents/vault-header"
import { CreateProjectCard } from "@/components/documents/create-project-card"
import { ProjectCard } from "@/components/documents/project-card"
...
export default function VaultPage() {
    const { projects, addProject, renameProject, deleteProject } = useDocuments()
    ...
    return (
        <div className="flex flex-col flex-1 w-full max-w-[1600px] mx-auto p-3 sm:p-4 md:p-6 space-y-6 md:space-y-8 h-full overflow-y-auto">
            ...
            <div className="space-y-3 md:space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 md:gap-4" id="project-grid">
