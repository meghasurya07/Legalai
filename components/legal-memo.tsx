...
import { ArrowLeft, Loader2, FileText, Download, BookOpen } from "lucide-react"
...
export default function LegalMemo() {
    ...
    const handleGenerate = async () => {
        ...
        try {
            const response = await fetch('/api/workflows/legal-memo', {
                method: 'POST',
...
`
        ...
        a.href = url
        a.download = `legal_memo_${Date.now()}.txt`
        document.body.appendChild(a)
        a.click()
        document.body.removeChild(a)
        URL.revokeObjectURL(url)
        toast.success("Legal memo downloaded")
    }
                ...
                <div className="max-w-7xl mx-auto p-6 md:p-8 lg:p-12 pb-32">
                    ...
                    <div className="flex items-center gap-4 mb-8">
                        ...
                        <div className="flex-1">
                            <h1 className="text-3xl font-bold tracking-tight mb-2">Draft Memo from Legal Research</h1>
                            <p className="text-muted-foreground">Generate comprehensive legal research memos</p>
                        </div>
                    </div>
