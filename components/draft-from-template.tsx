...
import { ArrowLeft, Loader2, FileText, Download, Plus, X } from "lucide-react"
...
export default function DraftFromTemplate() {
    ...
    const handleGenerate = async () => {
        ...
        try {
            const response = await fetch('/api/workflows/draft-from-template', {
                method: 'POST',
                ...
                <div className="max-w-7xl mx-auto p-6 md:p-8 lg:p-12 pb-32">
                    ...
                    <div className="flex items-center gap-4 mb-8">
                        ...
                        <div className="flex-1">
                            <h1 className="text-3xl font-bold tracking-tight mb-2">Draft from Template</h1>
                            <p className="text-muted-foreground">Generate legal documents from predefined templates</p>
                        </div>
                    </div>
