...
import { Loader2, FileText, CheckCircle2, AlertTriangle, Scale, Shield } from "lucide-react"
...
export default function DocumentComparison() {
    ...
    return (
        <ToolPageLayout title="Document Comparison" description="Compare legal documents and identify material differences">
